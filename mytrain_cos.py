...
class Args:
    def __init__(self):
        self.name = "sum_spot3_ratio50_new"
        ...
        self.load_checkpoint_dir = f"/home/gpuadmin/Desktop/RWKV/checkpoints/sum_spot3_ratio50(1)"
        self.loadormodel = "load"
...
def validate(model_engine, val_loader, device):
    ...
    with torch.no_grad():
        ...
        for step, batch in progressbar:
            ...
            ciou_loss = calculate_ciou(locs[0].to(torch.float32),batch["locs"].to(torch.float32)).to(args.dtype)
